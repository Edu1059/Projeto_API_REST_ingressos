...
router.get('/compra/busca/:id', CompraController.getIngressosByUsuario); 

router.get('/compra/busca', (req, res) => { res.render("buscaIngresso") });
router.post('/compra/busca', CompraController.getIngresso);  
